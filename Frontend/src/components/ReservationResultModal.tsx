  ...
  const renderSeatGrid = () => {
    ...
    for (let r = 1; r <= 3; r++) {
      for (let c = 1; c <= 3; c++) {
        ...
        let seatClass =
          'w-16 h-16 m-1 rounded-lg flex items-center justify-center text-white font-bold text-sm transition-all duration-200 ';
    ...
    <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4">
      <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-gray-800">🎭 예매 완료</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4">
                ...
                <div className="flex justify-center">
                  <div className="grid grid-cols-3 gap-1 rounded-lg bg-white p-3 shadow-inner">
                    {renderSeatGrid()}
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 text-center">
            <p className="mb-1 text-sm text-gray-600">예매 번호</p>
